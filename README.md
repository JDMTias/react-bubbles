...
- [x] Explain what a token is used for.
    A token is used to give autorization to a user so that he may have acces to private routes that you can't access without the token given once logged in. 
- [x] What steps can you take in your web apps to keep your data secure? require stronger passwords, encrypt your login page, learning about different types of attacks and prepping for them while developing your app, back up your data often,  use some security scanners, sanitize the user output, keep all scripts and platforms up to date, use a web app security platform, 2 factor authentication, secure Host.
- [x] Describe how web servers work.
      a web server takes incoming networks requests over http and other protocls and processes them,  it stores, process and deliver web pages to clients.
- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
  Create, read, update, and delete, which are get, post, put, and delete from axios are a few of the methods.
